const Uses = () => {
  return (
    <section className="px-5 py-32">
      <div className="sm-[32px] max-w-[1300px] m-auto">
        <div>
          <h2 className="text-5xl leading-14 sm:text-[5rem] heading-font uppercase text-center sm:leading-20">
            i code memorable experiences
          </h2>
        </div>
        <div className="relative flex justify-center mt-7">
          ...
          />
          <div>
            <div className="w-[400px] mt-14 mx-auto">
              <div className="mask-image overflow-hidden relative">
                <div className="flex scroller gap-7">
                  {/* logos */}
                  <div>
                    <svg
        ...
        {/* text below horizontal scroll */}
        <div>
          <p className="para-font max-w-[800px] text-xl mt-16 text-center mx-auto">
            With a strong foundation in web development gained through practical
            projects, JavaScript (or TypeScript) and React are my go-to tools
            for building web applications. Their flexibility and rich ecosystem
            enable me to create efficient and scalable solutions confidently.
          </p>
        </div>
      </div>
    </section>
